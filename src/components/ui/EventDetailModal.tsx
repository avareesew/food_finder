                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="mt-6 rounded-2xl border border-sky-800/40 bg-gradient-to-br from-sky-950/50 via-sky-950/30 to-indigo-950/20 p-5 sm:p-6">
                                        ...
                                        {expect ? (
                                            <div className="mt-4 flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-sm leading-relaxed text-gray-200">{expect}</p>
                                                </div>
                                            </div>
                                        ) : null}
                                        {signup ? (
                                            <div className={`flex items-center gap-3 ${expect ? 'mt-3 border-t border-sky-800/30 pt-3' : 'mt-4'}`}>
                                                ...
                                                {signupTextLooksLikeUrl(signup) ? (
                                                    ...
                                                    <p className="text-sm text-gray-200">{signup}</p>
                                                )}
                                            </div>
                                        ) : null}
                                    </div>
