...
export default function Home() {
  return (
    <main className="min-h-screen bg-brand-canvas text-brand-black pt-28 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center mb-16">
          ...
          <h1 className="text-6xl md:text-7xl font-serif text-brand-black mb-6 leading-[1.1]">
            Find Free Food & <br />
          ...
          {/* Search / CTA */}
          <div className="max-w-xl mx-auto bg-white p-2 rounded-full shadow-soft flex items-center border border-gray-100">
            ...
            <input
              ...
              className="flex-1 px-4 py-3 bg-transparent border-none focus:ring-0 text-gray-800 placeholder-gray-400 font-medium"
            />
            <Link href="/feed">
        ...
        <section className="mb-24">
          <div className="flex justify-between items-end mb-6">
            <div>
              <h2 className="text-3xl font-serif text-brand-black mb-2">Explore Nearby</h2>
              <p className="text-gray-500">Discover top-rated free food spots in your area.</p>
            </div>
            <Link href="/feed">
              <button className="px-6 py-2 border border-gray-200 rounded-full text-sm font-semibold hover:bg-white hover:border-brand-orange hover:text-brand-orange transition-colors">
                View All
              </button>
            </Link>
          </div>
          ...
          <div className="relative w-full h-[400px] md:h-[500px] bg-gray-100 rounded-[2.5rem] overflow-hidden shadow-card border-4 border-white">
            <CampusMap />

            {/* Floating "Live Now" Badge Override for Demo */}
            <div className="absolute bottom-6 left-6 z-[1000] bg-white p-4 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
              <div className="w-12 h-12 bg-brand-orange/10 rounded-full flex items-center justify-center text-xl">
                🍕
              </div>
              <div>
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                  <span className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Happening Now</span>
                </div>
                <div className="font-serif font-bold text-gray-900">Pizza Social @ TMCB</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24">
          <div className="flex justify-between items-end mb-8">
            <h2 className="text-3xl font-serif text-brand-black">Discover Events</h2>
            <Link href="/feed">
              <button className="px-6 py-2 border border-gray-200 rounded-full text-sm font-semibold hover:bg-white hover:border-brand-orange hover:text-brand-orange transition-colors">
                View All
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all group cursor-pointer">
                <div className="h-48 bg-gray-100 rounded-2xl mb-4 overflow-hidden relative">
                  ...
                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold text-brand-orange shadow-sm border border-black/5">
                    AVAILABLE
                  </div>
                </div>
                <div>
                  <h3 className="font-serif text-xl text-brand-black mb-1 group-hover:text-brand-orange transition-colors">
                    {i === 1 ? 'Morning Bagels' : i === 2 ? 'Club Salad Bar' : 'Late Night Burritos'}
                  </h3>
                  <p className="text-sm text-gray-500 mb-3">JFSB Lobby • Posted 20m ago</p>
        ...
        {/* TESTIMONIALS */}
        <section className="bg-white rounded-3xl p-8 md:p-12 mb-20 border border-gray-100/50 shadow-sm">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif text-brand-black mb-2">What they say about us</h2>
            <p className="text-gray-500">Watch what people says about scavenger.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-brand-canvas p-6 rounded-2xl border border-transparent hover:border-brand-orange/20 transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-serif text-sm font-bold text-brand-black">Tyler J.</div>
                  <div className="text-xs text-brand-gray">CS Sophomore</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-canvas p-6 rounded-2xl border border-transparent hover:border-brand-orange/20 transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-serif text-sm font-bold text-brand-black">Sarah M.</div>
                  <div className="text-xs text-brand-gray">Marketing Club Pres.</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-brand-canvas p-6 rounded-2xl border border-transparent hover:border-brand-orange/20 transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-serif text-sm font-bold text-brand-black">Marcus L.</div>
                  <div className="text-xs text-brand-gray">Heritage Halls RA</div>
                </div>
              </div>
            </div>
          </div>
