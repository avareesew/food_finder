...
- **Gmail Ingestion Pipeline** — Cron-triggered inbox ingest with image/text branching, dedupe marks, OpenAI extraction, Firestore persistence
...
| **Maps** | Leaflet | 1.9.4 |
| **Hosting** | Vercel (deployment handoff to teammate) | — |
